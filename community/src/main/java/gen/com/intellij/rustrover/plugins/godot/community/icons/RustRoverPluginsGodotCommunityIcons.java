package com.intellij.rustrover.plugins.godot.community.icons;
 ...
 */
public final class RustRoverPluginsGodotCommunityIcons {
  private static @NotNull Icon load(@NotNull String path, int cacheKey, int flags) {
    return IconManager.getInstance().loadRasterizedIcon(path, RustRoverPluginsGodotCommunityIcons.class.getClassLoader(), cacheKey, flags);
  }
